...
@ArgsType()
class UpdateClientsGroupArgs {
  @Field(() => ClientsGroupWhereUniqueInput, { nullable: false })
  where!: ClientsGroupWhereUniqueInput;
  @Field(() => ClientsGroupUpdateInput, { nullable: false })
  data!: ClientsGroupUpdateInput;
}

export { UpdateClientsGroupArgs };
