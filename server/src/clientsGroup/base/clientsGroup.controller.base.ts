...
import { ClientsGroupCreateInput } from "./ClientsGroupCreateInput";
...
export class ClientsGroupControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: ClientsGroup })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: ClientsGroupCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [ClientsGroup] })
  ...
  async findMany(
    ...
    const args = plainToClass(ClientsGroupFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: ClientsGroupWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
    ...
    if (invalidAttributes.length) {
      ...
      throw new common.ForbiddenException(
        `Updating the relationship: ${
          invalidAttributes[0]
        } of ${"ClientsGroup"} is forbidden for roles: ${roles}`
      );
    }
