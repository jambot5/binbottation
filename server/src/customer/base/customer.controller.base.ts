...
import { ClientsGroupFindManyArgs } from "../../clientsGroup/base/ClientsGroupFindManyArgs";
import { ClientsGroup } from "../../clientsGroup/base/ClientsGroup";
...
export class CustomerControllerBase {
  ...
  @common.Get("/:id/clientsGroup")
  @nestAccessControl.UseRoles({
    resource: "Customer",
    action: "read",
    possession: "any",
  })
  @ApiNestedQuery(ClientsGroupFindManyArgs)
  async findManyClientsGroup(
    @common.Req() request: Request,
    @common.Param() params: CustomerWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<ClientsGroup[]> {
    const query = plainToClass(ClientsGroupFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
    ...
    const results = await this.service.findClientsGroup(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  async updateClientsGroup(
    @common.Param() params: CustomerWhereUniqueInput,
    @common.Body() body: ClientsGroupWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
    const data = {
      clientsGroup: {
